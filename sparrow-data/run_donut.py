...
def main():
    ...
    train_files_list = files_list[:int(len(files_list) * 0.70)]
    print("Train set size:", len(train_files_list))
    validation_files_list = files_list[int(len(files_list) * 0.70):int(len(files_list) * 0.90)]
    print("Validation set size:", len(validation_files_list))
    test_files_list = files_list[int(len(files_list) * 0.90):]
